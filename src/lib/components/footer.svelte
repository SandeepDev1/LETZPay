<section class="scroll-smooth py-5 w-[100%] mt-5 rounded-t-3xl bg-slate-50">
    <div class="flex flex-col justify-center lg:flex-row p-10">
        <div class="docs  w-[100%] p-2">
            <h1 class="font-bold pl-2 text-2xl text-gray-900 ">Get Started Now</h1>
        ...
        <div class="docs  w-[100%] p-2 my-10 border-y-2 lg:px-4 lg:border-y-0 lg:border-x-2 lg:my-0">
            <h1 class="font-bold pl-2 mt-4 lg:mt-0 text-2xl text-gray-900 ">To Know More</h1>
        ...
        <div class="docs  w-[100%] p-2 lg:pl-4">
            <h1 class="font-bold pl-2 text-2xl text-gray-900 ">For Further Inquiries</h1>
    ...
    <div class="logo mx-[auto] flex justify-center border-t-2 pt-5 items-center">
        <div>
            <img
                alt="logo"
                class=" w-[40px] h-[40px] bg-white rounded-full p-1 outline outline-2 "
                src="/letzpay.png"
            />
        </div>
        <div class=" "><a href="/#" class="p-5 pl-2"><b class=" font-extrabold">LETZ</b>pay</a></div>
    </div>
</section>